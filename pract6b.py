...
class ART:
    ...
    def learn(self, X):
        ''' Learn X '''
        if len(X) != self.Wf.shape[1]:
            raise ValueError("Input vector X dimension does not match the number of features in the network.")
        ...
        # and make the newly active unit learn data
...
if __name__ == '__main__':
    ...
    data = [" O ", " O O", "O", " O O", "O", " OO O", " OO ", "OOO ", "OO ", "O ", "OO ", "OOO ", "OOOO ", "OOOOO", "O", "O", " O ", "O ", "O", " O O", " OO O", " OO ", "OOO ", "OO ", "OOOO ", "OOOOO"]
